...
---
# ODDER
We are using ODDER, a digital platform to develop and distribute digital endowment reports for our donors. Digital reports create a more interactive experience for stewardees and it allows us to add greater personalization at scale.
...
With ODDER we will create personalized sites for each stewardee. Within that site, stewardees will see a variety of content: stories, pictures, videos, and their financial reports. If a stewardee receives reports for multiple funds, they will all appear on the same site. They will also have the option to print out the financials if they wish.
...
Because this system is entirely digital, we rely heavily on email address availability. Please help us obtain email addresses for stewardees who we don't have emails on file.
